  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-2 inline-flex justify-center border border-ink bg-ink px-6 py-3 text-sm tracking-wide text-background transition-colors hover:bg-background hover:text-ink disabled:opacity-50"
      >
